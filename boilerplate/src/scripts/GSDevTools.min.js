...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("GSDevTools", ["TweenLite", "core.Animation", "core.SimpleTimeline", "TimelineLite", "utils.Draggable", "plugins.CSSPlugin"], function(e, t, o, n, i) {
      var r, s, a, l, c, d = document,
        ...
        h = {},
        //m = "greensock.com",
        //v = "/requires-membership/",
        /*x = function(e) {
          for (var t = -1 !== (window ? window.location.href : "").indexOf("greensock") && -1 !== e.indexOf("localhost"), o = [
            m, "codepen.io", "codepen.dev", "css-tricks.com", "cdpn.io",
            "gannon.tv", "codecanyon.net", "themeforest.net", "cerebrax.co.uk",
            "tympanus.net", "tweenmax.com", "tweenlite.com", "plnkr.co",
            "hotjar.com", "webpackbin.com", "archive.org", "jsfiddle.net"
          ], n = o.length; --n > -1;)
            if (-1 !== e.indexOf(o[n])) return !0;
          return t && window && window.console && "WARNING: a special version of GSDevTools is running locally, but it will not work on a live domain because it is a membership benefit of Club GreenSock. Please sign up at http://greensock.com/club/ and then download the 'real' version from your GreenSock account which has no such limitations. The file you're using was likely downloaded from elsewhere on the web and is restricted to local use or on sites like codepen.io.", t
        ...
        _ = function(e) {
          ...
          for (var o = T(b, !0), n = o.length; --n > -1;)
        ...
        R = function(o) {
          this.vars = o = o || {};
          console.log(o);
          o.id = "string" == typeof o.animation ? o.animation : u++;
          h[o.id + ""] = this;
          //if (this.vars = o = o || {}, o.id = o.id || ("string" == typeof o.animation ? o.animation : u++), h[o.id + ""] = this, !x) return window.location.href = "http://" + m + v + "?plugin=GSDevTools&source=greensock", !1;
          var n, r, s, l, d, g, f, b, k, X, O = this,
            ...
            ue = H(fe),
            he = function(e) {
              F("loop", g = e), g ? (ue.play(), b.progress() >= oe / 100 && b.progress(te / 100).resume()) : ue.reverse()
            },
            me = function() {
              he(!g)
            },
            ...
            we = function(n) {
              ...
              if ("string" == typeof n && (n = _(n)), n instanceof t || console.log("GSDevTools error: invalid animation."), n !== f) {
                if (f && (f._inProgress = te, f._outProgress = oe), f = n, b && (c = b.timeScale(), b.target === k && (k.resume(), b.kill())), te = f._inProgress || 0, oe = f._outProgress || 100, K.style.left = te + "%", J.style.left = oe + "%", X && (F("animation", f.vars.id), F("in", te), F("out", oe)), r = 0, l = Math.min(1e3, o.maxDuration || 1e3, S(f)), f === N || !1 !== o.globalSync) {
                  if (Y(), b = E, a && a !== O && console.log("Error: GSDevTools can only have one instance that's globally synchronized."), a = O, f !== N)
                    for ((s = (i = f).totalDuration()) > 99999999 && (s = i.duration()); i.timeline.timeline;) r = r / i._timeScale + i._startTime, s = s / i._timeScale + i._startTime, i = i.timeline;
                  else s = N.duration();
                  ...
                  if (a === O && (a = null), f !== k && k) {
                    for ((s = (i = f).totalDuration()) > 99999999 && (s = i.duration()); i.timeline.timeline && i !== k;) r = r / i._timeScale + i._startTime, s = s / i._timeScale + i._startTime, i = i.timeline;
                ...
                U.innerHTML = b.duration().toFixed(2), D(ve, f.vars.id, xe)
              }
            },
            be = function() {
              var e, t, o;
              f === N && (e = (E._timeline._time - E._startTime) * E._timeScale, 1e3 === (o = Math.min(1e3, N.duration())) && (o = Math.min(1e3, S(N))), 1 !== (t = E.duration() / o) && o && (te *= t, oe < 100 && (oe *= t), E.seek(0), E.vars.time = o, E.invalidate(), E.duration(o), E.time(e), U.innerHTML = o.toFixed(2), re(!0)))
            },
            ...
            Pe = function(e) {
              ...
              var t = _(W("animation"));
              t && (t._inProgress = W("in") || 0, t._outProgress = W("out") || 100), o.paused && de(), f = null, we(k || t || N);
              var n = o.timeScale || W("timeScale"),
                i = t === f;
              n && (D(Te, n, Se, n + "x"), E.timeScale(n)), 100 === (te = ("inTime" in o ? C(o.inTime, f, 0, 0) : i ? t._inProgress : 0) || 0) && !o.animation && t && (we(N), te = C(o.inTime, f, 0, 0) || 0), te && (K.style.left = te + "%", K.style.display = J.style.display = "block"), (oe = ("outTime" in o ? C(o.outTime, f, 100, te) : i ? t._outProgress : 0) || 100) < te && (oe = 100), 100 !== oe && (J.style.left = oe + "%", K.style.display = J.style.display = "block"), (g = "loop" in o ? o.loop : W("loop")) && he(!0), o.paused && b.progress(te / 100, !0).pause(), A && f === N && I && !1 !== o.globalSync && !le && b.time(-I, !0), re(!0)
            };
          L(ve, "change", function(e) {
          ...
          }), L(z(".rewind"), "mousedown", ge), L(fe, "mousedown", me), L(Te, "change", function(t) {
            ...
            32 === o ? pe() : 38 === o ? (t = parseFloat(P(Te, -1, Se)), b.timeScale(t), F("timeScale", t)) : 40 === o ? (t = parseFloat(P(Te, 1, Se)), b.timeScale(t), F("timeScale", t)) : 37 === o ? ge() : 39 === o ? b.progress(oe / 100) : 76 === o ? me() : 72 === o ? Le() : 73 === o ? (te = 100 * b.progress(), F("in", te), K.style.left = te + "%", re(!0)) : 79 === o && (oe = 100 * b.progress(), F("out", oe), J.style.left = oe + "%", re(!0))
          }))), e.set(V, {
            xPercent: -50,
            x: 0,
            data: "root"
            ...
            x: 0,
            data: "root"
          }), K._gsIgnore = J._gsIgnore = V._gsIgnore = se._gsIgnore = fe._gsIgnore = !0, e.killTweensOf([K, J, V]), Pe(A), A && e.delayedCall(1e-4, Pe, [!1], this), e.ticker.addEventListener("tick", re), this.update = function(e) {
      ...
      return R.version = "0.1.5", R.logOverwrites = !1, R.getById = function(e) {
        ...
        var e, t, n;
        if (!a)
          for (Y(), e = N._first, n = N._startTime; e;) t = e._next, e._totalDuration !== e._totalTime || 1 !== e.ratio ? o.prototype.add.call(b, e, e._startTime - e._delay + n) : e.kill(), e = t;
        z = !1, A = !1
  ...
  function(e) {
    ...
    _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function(e, t, o) {
      var n, i, r, s, a, l, c, d, p, g = {
        ...
        ne = y.defaultView ? y.defaultView.getComputedStyle : _,
        ...
        pe = function() {
          ...
          y.body && ue && (g.position = "absolute", f.appendChild(p), p.appendChild(i), n = i.offsetParent, p.style[ue] = "rotate(1deg)", d = i.offsetParent === n, p.style.position = "absolute", g.height = "10px", n = i.offsetTop, p.style.border = "5px solid red", c = n !== i.offsetTop, f.removeChild(p)), g = r.style, r.setAttributeNS(null, "width", "400px"), r.setAttributeNS(null, "height", "400px"), r.setAttributeNS(null, "viewBox", "0 0 400 400"), g.display = "block", g.boxSizing = "border-box", g.border = "0px solid red", g.transform = "none", i.style.cssText = "width:100px;height:100px;overflow:scroll;-ms-overflow-style:none;", f.appendChild(i), i.appendChild(r), t = (o = r.createSVGPoint().matrixTransform(r.getScreenCTM())).y, i.scrollTop = 100, o.x = o.y = 0, o = o.matrixTransform(r.getScreenCTM()), l = t - o.y < 100.1 ? 0 : t - o.y - 150, i.removeChild(r), f.removeChild(i), f.appendChild(r), u && (f.style.display = "block"), t = (e = r.getScreenCTM()).e, g.border = "50px solid red", e = r.getScreenCTM(), 0 === t && 0 === e.e && 0 === e.f && 1 === e.a ? (s = 1, a = !0) : (s = t !== e.e ? 1 : 0, a = 1 !== e.a), u && (f.style.display = "flex"), f.removeChild(r)
        },
        ge = "" !== te(T, "perspective"),
        fe = te(T, "transformOrigin").replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(),
        ue = te(T, "transform"),
        ...
        Se = function(e) {
          ...
          var o, n, i, r, c, d, p, g, f, u, h, m, v = e,
            x = Ce(e);
          ...
          for (n = i.getBoundingClientRect(), c = e.getScreenCTM(), p = (g = e.createSVGPoint()).matrixTransform(c), g.x = g.y = 10, g = g.matrixTransform(c), x.scaleX = (g.x - p.x) / 10, x.scaleY = (g.y - p.y) / 10, void 0 === s && pe(), x.borderBox && !a && e.getAttribute("width") && (r = ne(e) || {}, f = parseFloat(r.borderLeftWidth) + parseFloat(r.borderRightWidth) || 0, u = parseFloat(r.borderTopWidth) + parseFloat(r.borderBottomWidth) || 0, h = parseFloat(r.width) || 0, m = parseFloat(r.height) || 0, x.scaleX *= (h - f) / h, x.scaleY *= (m - u) / m), l ? (o = e.getBoundingClientRect(), x.offsetLeft = o.left - n.left, x.offsetTop = o.top - n.top) : (x.offsetLeft = p.x - n.left, x.offsetTop = p.y - n.top), x.offsetParent = i, d = Te.length; --d > -1;) Te[d].style[ue] = be[d];
          return x
        },
        _e = function(e, o) {
        ...
        ke = function(e, t, o, n, i) {
          ...
          var r, a, l, p, g, f, u, h, m, v, x, b, T, S, _ = e._dCache || Ce(e),
            C = e.parentNode,
            k = C._dCache || Ce(C),
            M = _.computedStyle,
            L = _.isSVG ? k.offsetParent : C.offsetParent;
          return r = _.isSVG && -1 !== (e.style[ue] + "").indexOf("matrix") ? e.style[ue] : M ? M.getPropertyValue(he) : e.currentStyle ? e.currentStyle[ue] : "1,0,0,1,0,0", e.getBBox && -1 !== (e.getAttribute("transform") + "").indexOf("matrix") && (r = e.getAttribute("transform")), (r = (r + "").match(/(?:\-|\.|\b)(\d|\.|e\-)+/g) || [1, 0, 0, 1, 0, 0]).length > 6 && (r = [r[0], r[1], r[4], r[5], r[12], r[13]]), n ? r[4] = r[5] = 0 : _.isSVG && (g = e._gsTransform) && (g.xOrigin || g.yOrigin) && (r[0] = parseFloat(r[0]), r[1] = parseFloat(r[1]), r[2] = parseFloat(r[2]), r[3] = parseFloat(r[3]), r[4] = parseFloat(r[4]) - (g.xOrigin - (g.xOrigin * r[0] + g.yOrigin * r[2])), r[5] = parseFloat(r[5]) - (g.yOrigin - (g.xOrigin * r[1] + g.yOrigin * r[3]))), t && (void 0 === s && pe(), l = _.isSVG || _.isSVGRoot ? Se(e) : e, _.isSVG ? (p = e.getBBox(), v = k.isSVGRoot ? {
            x: 0,
            y: 0
          } : C.getBBox(), l = {
            offsetLeft: p.x - v.x,
        ...
        Pe = function(e, t, o) {
          ...
          t = ee(t);
          var n, i, r, s, a, l, c, d, p, g, f, u, h, m, v, x, b, T, S, _, C, k, M = e.getBBox && ye(e);
          ...
          return e === t ? {
            ...
            x: i,
            y: a
          }, l, c), i = Math.min(d.x, p.x, g.x, f.x), s = Math.min(d.y, p.y, g.y, f.y), H.x = H.y = 0, o && _e(t, H), {
            left: i + H.x,
            top: s + H.y,
        ...
        Ee = "ontouchstart" in w && "orientation" in window,
        Ye = function(e) {
        ...
        Ve = function(e, o) {
          ...
          ge && !1 !== o.force3D ? (a = "translate3d(", l = "px,0px)") : ue && (a = "translate(", l = "px)"), this.scrollTop = function(e, t) {
            ...
            (n = -n) < 0 ? (u = n - .5 | 0, n = 0) : n > b ? (u = n - b | 0, n = b) : u = 0, (u || s) && (a ? this._suspendTransforms || (d[ue] = a + -u + "px," + -f + l) : d.left = -u + "px", We && u + w >= 0 && (d.paddingRight = u + w + "px")), e.scrollLeft = 0 | n, m = e.scrollLeft
            ...
            (n = -n) < 0 ? (f = n - .5 | 0, n = 0) : n > T ? (f = n - T | 0, n = T) : f = 0, (f || s) && (a ? this._suspendTransforms || (d[ue] = a + -u + "px," + -f + l) : d.top = -f + "px"), e.scrollTop = 0 | n, h = e.scrollTop
        ...
        Ge = function(n, s) {
          ...
          var a, l, c, d, p, v, x, b, T, _, P, E, F, V, j, q, $, te, ne, ie, re, se, ae, pe, ge, fe, ue, he, me, ve, xe, we, be, Te, Se = (s.type || (L ? "top,left" : "x,y")).toLowerCase(),
            ...
            nt = function(e) {
              if (Re.autoScroll && Re.isDragging && (Ue || te)) {
                ...
                for (Ue = !1, R.scrollTop = null != window.pageYOffset ? window.pageYOffset : null != w.scrollTop ? w.scrollTop : y.body.scrollTop, R.scrollLeft = null != window.pageXOffset ? window.pageXOffset : null != w.scrollLeft ? w.scrollLeft : y.body.scrollLeft, r = Re.pointerX - R.scrollLeft, s = Re.pointerY - R.scrollTop; p && !o;) t = (o = Q(p.parentNode)) ? R : p.parentNode, i = o ? {
                  ...
                  left: 0,
                  top: 0
                } : t.getBoundingClientRect(), a = c = 0, Ne && ((d = t._gsMaxScrollY - t.scrollTop) < 0 ? c = d : s > i.bottom - Ke && d ? (Ue = !0, c = Math.min(d, g * (1 - Math.max(0, i.bottom - s) / Ke) | 0)) : s < i.top + Qe && t.scrollTop && (Ue = !0, c = -Math.min(t.scrollTop, g * (1 - Math.max(0, s - i.top) / Qe) | 0)), c && (t.scrollTop += c)), Pe && ((d = t._gsMaxScrollX - t.scrollLeft) < 0 ? a = d : r > i.right - $e && d ? (Ue = !0, a = Math.min(d, g * (1 - Math.max(0, i.right - r) / $e) | 0)) : r < i.left + Je && t.scrollLeft && (Ue = !0, a = -Math.min(t.scrollLeft, g * (1 - Math.max(0, r - i.left) / Je) | 0)), a && (t.scrollLeft += a)), o && (a || c) && (window.scrollTo(t.scrollLeft, t.scrollTop), vt(Re.pointerX + a, Re.pointerY + c)), p = t
              }
              if (te) {
                var f = Re.x,
                  u = Re.y;
                f < 1e-6 && f > -1e-6 && (f = 0), u < 1e-6 && u > -1e-6 && (u = 0), Ce ? (Re.deltaX = f - me.data.rotation, me.data.rotation = Re.rotation = f, me.setRatio(1)) : l ? (Ne && (Re.deltaY = u - l.top(), l.top(u)), Pe && (Re.deltaX = f - l.left(), l.left(f))) : _e ? (Ne && (Re.deltaY = u - me.data.y, me.data.y = u), Pe && (Re.deltaX = f - me.data.x, me.data.x = f), me.setRatio(1)) : (Ne && (Re.deltaY = u - parseFloat(n.style.top || 0), n.style.top = u + "px"), Pe && (Re.deltaY = f - parseFloat(n.style.left || 0), n.style.left = f + "px")), !b || e || we || (we = !0, ce(Re, "drag", "onDrag"), we = !1)
              }
              te = !1
            },
            it = function(e, o) {
            ...
            rt = function() {
              var e, t, o, i;
              x = !1, l ? (l.calibrate(), Re.minX = _ = -l.maxScrollLeft(), Re.minY = E = -l.maxScrollTop(), Re.maxX = T = Re.maxY = P = 0, x = !0) : s.bounds && (e = de(s.bounds, n.parentNode), Ce ? (Re.minX = _ = e.left, Re.maxX = T = e.left + e.width, Re.minY = E = Re.maxY = P = 0) : void 0 !== s.bounds.maxX || void 0 !== s.bounds.maxY ? (e = s.bounds, Re.minX = _ = e.minX, Re.minY = E = e.minY, Re.maxX = T = e.maxX, Re.maxY = P = e.maxY) : (t = de(n, n.parentNode), Re.minX = _ = le(n, ke) + e.left - t.left, Re.minY = E = le(n, De) + e.top - t.top, Re.maxX = T = _ + (e.width - t.width), Re.maxY = P = E + (e.height - t.height)), _ > T && (Re.minX = T, Re.maxX = T = _, _ = Re.minX), E > P && (Re.minY = P, Re.maxY = P = E, E = Re.minY), Ce && (Re.minRotation = _, Re.maxRotation = T), x = !0), s.liveSnap && (i = (o = !0 === s.liveSnap ? s.snap || {} : s.liveSnap) instanceof Array || "function" == typeof o, Ce ? (ie = ft(i ? o : o.rotation, _, T, 1), re = null) : o.points ? se = ut(i ? o : o.points, _, T, E, P, o.radius, l ? -1 : 1) : (Pe && (ie = ft(i ? o : o.x || o.left || o.scrollLeft, _, T, l ? -1 : 1)), Ne && (re = ft(i ? o : o.y || o.top || o.scrollTop, E, P, l ? -1 : 1))))
            },
            st = function() {
            ...
            ct = function(e) {
              var t, o, i, r, s, a, l, p, g, f = ge || [1, 0, 0, 1, 0, 0];
              ge = Me(n.parentNode, !0), e && Re.isPressed && f.join(",") !== ge.join(",") && (t = f[0], o = f[1], i = f[2], r = f[3], s = f[4], a = f[5], g = c * (-o / (l = t * r - o * i)) + d * (t / l) + -(t * a - o * s) / l, d = (p = c * (r / l) + d * (-i / l) + (i * a - r * s) / l) * ge[1] + g * ge[3] + ge[5], c = p * ge[0] + g * ge[2] + ge[4]), ge[1] || ge[2] || 1 != ge[0] || 1 != ge[3] || 0 != ge[4] || 0 != ge[5] || (ge = null)
            },
            dt = function() {
              var e = 1 - Re.edgeResistance;
              ct(!1), ge && (c = Re.pointerX * ge[0] + Re.pointerY * ge[2] + ge[4], d = Re.pointerX * ge[1] + Re.pointerY * ge[3] + ge[5]), te && (vt(Re.pointerX, Re.pointerY), nt(!0)), l ? (rt(), v = l.top(), p = l.left()) : (pt() ? (it(!0, !0), rt()) : Re.applyBounds(), Ce ? ($ = Re.rotationOrigin = Le(n, {
                x: 0,
                y: 0
            ...
            ut = function(e, t, o, n, i, r, s) {
              return r = r && r < k ? r * r : k, "function" == typeof e ? function(a) {
                var l, c, d, p = Re.isPressed ? 1 - Re.edgeResistance : 1,
                  g = a.x,
                  f = a.y;
                return a.x = g = g > o ? o + (g - o) * p : g < t ? t + (g - t) * p : g, a.y = f = f > i ? i + (f - i) * p : f < n ? n + (f - n) * p : f, (l = e.call(Re, a)) !== a && (a.x = l.x, a.y = l.y), 1 !== s && (a.x *= s, a.y *= s), r < k && (c = a.x - g) * c + (d = a.y - f) * d > r && (a.x = g, a.y = f), a
            ...
            ht = function(e, o) {
              ...
              if (a && !Re.isPressed && e && ("mousedown" !== e.type && "pointerdown" !== e.type || o || !(M() - tt < 30) || !Ye[Re.pointerEvent.type])) {
                ...
                if (ve = !(!pe || Pe === Ne || !1 === Re.vars.allowNativeTouchScrolling) && (Pe ? "y" : "x"), L ? e = J(e, !0) : ve || Re.allowEventDefault || (e.preventDefault(), e.preventManipulation && e.preventManipulation()), e.changedTouches ? (e = j = e.changedTouches[0], q = e.identifier) : e.pointerId ? q = e.pointerId : j = q = null, Y++, I(nt), d = Re.pointerY = e.pageY, c = Re.pointerX = e.pageX, (ve || Re.autoScroll) && K(n.parentNode), !n.parentNode || !Re.autoScroll || l || Ce || !n.parentNode._gsMaxScrollX || D.parentNode || n.getBBox || (D.style.width = n.parentNode.scrollWidth + "px", n.parentNode.appendChild(D)), dt(), Re.tween && Re.tween.kill(), Re.isThrowing = !1, t.killTweensOf(l || n, !0, je), l && t.killTweensOf(n, !0, {
                    scrollTo: 1
                  }), Re.tween = Re.lockedAxis = null, (s.zIndexBoost || !Ce && !l && !1 !== s.zIndexBoost) && (n.style.zIndex = Ge.zIndex++), Re.isPressed = !0, b = !(!s.onDrag && !Re._listeners.drag), !Ce)
                  for (i = We.length; --i > -1;) oe(We[i], "cursor", s.cursor || "move");
                ce(Re, "press", "onPress")
              }
            },
            mt = function(e) {
              ...
              if (a && !i && Re.isPressed && e) {
                ...
                if (L) e = J(e, !0);
                  ...
                  if (pe && ve && !xe && (o = e.pageX, n = e.pageY, ge && (r = o * ge[0] + n * ge[2] + ge[4], n = o * ge[1] + n * ge[3] + ge[5], o = r), s = Math.abs(o - c), l = Math.abs(n - d), (s !== l && (s > Xe || l > Xe) || O && ve === xe) && (xe = s > l && Pe ? "x" : "y", !1 !== Re.vars.lockAxisOnTouchScroll && (Re.lockedAxis = "x" === xe ? "y" : "x", "function" == typeof Re.vars.onLockAxis && Re.vars.onLockAxis.call(Re, p)), O && ve === xe))) return void xt(p);
            ...
            vt = function(e, t) {
              var o, n, i, r, s, a, l = 1 - Re.dragResistance,
                g = 1 - Re.edgeResistance;
              Re.pointerX = e, Re.pointerY = t, Ce ? (r = Math.atan2($.y - t, e - $.x) * C, (s = Re.y - r) > 180 ? v -= 360 : s < -180 && (v += 360), Re.x !== p || Math.abs(v - r) > Xe ? (Re.y = r, i = p + (v - r) * l) : i = p) : (ge && (a = e * ge[0] + t * ge[2] + ge[4], t = e * ge[1] + t * ge[3] + ge[5], e = a), o = e - c, (n = t - d) < Xe && n > -Xe && (n = 0), o < Xe && o > -Xe && (o = 0), (Re.lockAxis || Re.lockedAxis) && (o || n) && ((a = Re.lockedAxis) || (Re.lockedAxis = a = Pe && Math.abs(o) > Math.abs(n) ? "y" : Ne ? "x" : null, a && "function" == typeof Re.vars.onLockAxis && Re.vars.onLockAxis.call(Re, Re.pointerEvent)), "y" === a ? n = 0 : "x" === a && (o = 0)), i = p + o * l, r = v + n * l), (ie || re || se) && (Re.x !== i || Re.y !== r && !Ce) ? (se && (H.x = i, H.y = r, i = (a = se(H)).x, r = a.y), ie && (i = ie(i)), re && (r = re(r))) : x && (i > T ? i = T + (i - T) * g : i < _ && (i = _ + (i - _) * g), Ce || (r > P ? r = P + (r - P) * g : r < E && (r = E + (r - E) * g))), Ce || ge || (i = Math.round(i), r = Math.round(r)), (Re.x !== i || Re.y !== r && !Ce) && (Ce ? (Re.endRotation = Re.x = Re.endX = i, te = !0) : (Ne && (Re.y = Re.endY = r, te = !0), Pe && (Re.x = Re.endX = i, te = !0)), !Re.isDragging && Re.isPressed && (Re.isDragging = !0, ce(Re, "dragstart", "onDragStart")))
            },
            xt = function(e, o) {
              if (a && Re.isPressed && (!e || null == q || o || !(e.pointerId && e.pointerId !== q || e.changedTouches && !He(e.changedTouches, q)))) {
                ...
                if (W(nt), !Ce)
                  for (r = We.length; --r > -1;) oe(We[r], "cursor", s.cursor || "move");
                if (g && (qe = B = M(), Re.isDragging = !1), Y--, e) {
                ...
                return p && !g ? (fe && (s.snap || s.bounds) && lt(s.throwProps), ce(Re, "release", "onRelease"), O && "touchmove" === p.type || -1 !== p.type.indexOf("cancel") || (ce(Re, "click", "onClick"), M() - tt < 300 && ce(Re, "doubleclick", "onDoubleClick"), c = p.target || p.srcElement || n, tt = M(), d = function() {
                ...
                }, O || p.defaultPrevented || t.delayedCall(1e-5, d))) : (lt(s.throwProps), L || Re.allowEventDefault || !p || !s.dragClickables && et.call(Re, p.target) || !g || ve && (!xe || ve !== xe) || !1 === p.cancelable || (p.preventDefault(), p.preventManipulation && p.preventManipulation()), ce(Re, "release", "onRelease")), pt() && f.duration(Re.tween.duration()), g && ce(Re, "dragend", "onDragEnd"), !0
              }
            },
            yt = function(e) {
              if (e && Re.isDragging && !l) {
                ...
                (o || i) && (ge ? (c -= o * ge[0] + i * ge[2], d -= i * ge[3] + o * ge[1]) : (c -= o, d -= i), t._gsScrollX += o, t._gsScrollY += i, vt(Re.pointerX, Re.pointerY))
              }
            },
            wt = function(e) {
              var t = M(),
            ...
            bt = function(e) {
              return ge ? {
                x: e.x * ge[0] + e.y * ge[2] + ge[4],
                y: e.x * ge[1] + e.y * ge[3] + ge[5]
              } : {
                x: e.x,
                y: e.y
              }
          ...
          (ne = Ge.get(this.target)) && ne.kill(), this.startDrag = function(e, t) {
            ...
            if (!Ce)
              for (t = We.length; --t > -1;) oe(We[t], "cursor", null);
            if ("soft" !== e) {
            ...
            force3D: !0
          }), Ce ? je.rotation = 1 : (Pe && (je[ke] = 1), Ne && (je[De] = 1)), Ce ? (V = (F = h).css, F.overwrite = !1) : _e && (V = (F = Pe && Ne ? g : Pe ? f : u).css, F.overwrite = !1), this.enable()
        },
